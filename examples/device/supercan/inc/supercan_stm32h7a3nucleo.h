...
#define SC_BOARD_NAME "NUCLEO-H7A3"
...
struct MCanX {
  ...
  __IO MCANX_XIDFC_Type            XIDFC;       /**< \brief Offset: 0x88 (R/W 32) Extended ID Filter Configuration */                 Address offset: 0x088 */
